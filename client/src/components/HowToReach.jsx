        ...
        <div id="how-to-reach" className="my-20 min-h-96 w-screen px-10">
            <div className="relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden">
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
                        ...
                        <div className="space-y-6 font-circular-web text-lg text-blue-50 opacity-80">
                            ...
                            <div>
                                ...
                                <p>
                                    Phone: <span className="text-green-300">{LAHORE_ZOO_PHONE}</span>
                                </p>
                                <p>
                                    Email:{" "}
                ...
                <div className="absolute -bottom-10 -right-10 hidden md:block z-20 pointer-events-none">
                    <img
                        ref={parrotRef}
                        src="/img/animals/animal-07.jpg"
                        alt="Wildlife resident"
                        className="w-64 rounded-[2rem] border border-white/10 object-cover shadow-2xl lg:w-80"
                    />
                </div>
            </div>
        </div>
